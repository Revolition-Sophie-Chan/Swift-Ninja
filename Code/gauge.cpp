...
void CGauge::Load(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, "Data/Texture/fade.png", &m_pTextureGauge[UITYPE_FEVER]);
	D3DXCreateTextureFromFile(pDevice, "Data/Texture/fade.png", &m_pTextureGauge[UITYPE_HP]);
	D3DXCreateTextureFromFile(pDevice, "Data/Texture/fade.png", &m_pTextureGauge[UITYPE_FEVERMAX]);
	D3DXCreateTextureFromFile(pDevice, "Data/Texture/fade.png", &m_pTextureGauge[UITYPE_HPMAX]);
}
